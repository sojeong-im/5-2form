...
function App() {
  ...
  return (
    <div className="min-h-screen py-10 px-4 md:px-8 flex justify-center bg-[#e5e5e5] bg-[url('https://www.transparenttextures.com/patterns/rice-paper-2.png')]">
      
      <motion.div 
        initial={{ y: 50, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.6, ease: 'easeOut' }}
        className="w-full max-w-2xl bg-order-bg shadow-2xl relative"
        style={{
      ...
      >
        ...
        <div className="p-8 md:p-12">
          ...
          <div className="space-y-12">
            ...
            {/* 7 */}
            <div>
              <label className="block font-bold text-lg mb-4">7. 평소 어떤 음식을 가장 좋아하세요? 🍽️ <span className="text-sm font-normal text-gray-500">(복수 선택)</span></label>
              <div className="flex flex-wrap">
                ...
                <CheckItem label="🌶️ 매운 음식" field="favoriteFood" value="매운 음식" />
            ...
            {/* 12 */}
            <div>
              <label className="block font-bold text-lg mb-2">12. 한끼합쇼에 지원하게 된 이유 ✍️</label>
          ...
          <div className="mt-16 pt-8 border-t-4 border-double border-order-line">
            ...
            <div className="mt-12 flex flex-col items-center">
              ...
              <motion.button
                ...
                onClick={() => alert("주문이 접수되었습니다! 한끼합쇼에서 만나요 🍽️")}
              >
                주문하기 🛎️
              </motion.button>
            </div>
